...
execute as @e[tag=graves.interaction.new,limit=1,sort=nearest] store result score @s graves.id run scoreboard players get @p[scores={graves.death=1..}] utils.player.id
