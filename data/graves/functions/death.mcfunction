...
summon interaction ~0.5 ~ ~0.5 {width:1f,height:1f,response:1b,Tags:["graves.interaction","graves.interaction.new"]}
...
execute as @e[tag=graves.item,distance=..5] run function graves:teleport
